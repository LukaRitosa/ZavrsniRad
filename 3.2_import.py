...
ALATI = {
    "Virtual Classroom":     ["zoom-workplace", "speexx", "cisco-webex-suite", "adobe-connect", "powerschool-schoology-learning"],
...
with open("data2/tools_features3.csv", "w", newline="", encoding="utf-8") as f:
    writer = csv.writer(f)
...
print(f"\n{len(rezultati)} alata → data2/tools_features3.csv ({len(svi_kljucevi)} feature stupaca)")
...
Dohvaćam: speexx...
  Speexx | features: 48
Dohvaćam: cisco-webex-suite...
  Webex Suite | features: 107
Dohvaćam: adobe-connect...
  Adobe Connect | features: 33
Dohvaćam: powerschool-schoology-learning...
  powerschool-schoology-learning | features: 0
Dohvaćam: echo360...
  Echo360 | features: 9
Dohvaćam: ispring-suite...
  iSpring Suite | features: 45
...
19 alata → data/tools_features3.csv (360 feature stupaca)
(.venv) PS C:\Users\sverk\Desktop\Zavrsni\ZavrsniRad> python 3_import.py
Dohvaćam: zoom-workplace...
  Zoom Workplace | features: 157
Dohvaćam: speexx...
  Speexx | features: 48
...
Dohvaćam: lanschool...
  LanSchool | features: 7
Dohvaćam: smart-technologies-lumio...
  smart-technologies-lumio | features: 0
Dohvaćam: brainscape...
  brainscape | features: 0
Dohvaćam: quizlet...
  quizlet | features: 0
Dohvaćam: quizizz...
  quizizz | features: 0
Dohvaćam: schoolstatus...
  schoolstatus | features: 0
Dohvaćam: talkingpoints...
  talkingpoints | features: 0
Dohvaćam: parentsquare...
  parentsquare | features: 0

19 alata → data2/tools_features3.csv (354 feature stupaca)
'''